...
public class WrTextView extends AppCompatTextView
{
    ...
    public WrTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs, defStyle);
    }

    public WrTextView(Context context, AttributeSet attrs) {
